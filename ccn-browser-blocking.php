...
add_action( 'wp_footer', function() {
	...
	?><script type='text/javascript'>var checkUA=function(){var d=new RegExp(jvL10n.userAgent),a=(navigator.userAgent||navigator.vendor||window.opera).toLowerCase();newBrowserURL=jvL10n.url.mobile+(window.location.hostname+window.location.pathname);d.test(a)&&(/android/i.test(a)&&(window.location.href=newBrowserURL),/ipad|iphone|ipod/.test(a)&&(window.location.href=newBrowserURL.replace("navigate?url=","")),setTimeout(function(){var e=document.createElement("div"),b=e.cloneNode(!0),f=document.createElement("h3"),c=document.createElement("button"),d=document.createTextNode(jvL10n.text.title),g=document.createTextNode(jvL10n.text.button);f.appendChild(d);c.setAttribute("style","background:#800000 url("+jvL10n.url.icon+") left 5% center no-repeat;color:#ffffff;padding-left:33px");c.appendChild(g);b.className="bbccn";b.setAttribute("style","background:#ffffff;opacity:0.8;width:50%;border:1px solid #efefef;padding:50px;position:fixed;z-index:99999;top:50%;left:50%;transform: translate(-50%, -50%);text-align:center");e.setAttribute("style","opacity:0.85;background:#000000;width:100%;height:100%;position:fixed;z-index:99998;top:0");b.appendChild(f);b.appendChild(c);document.documentElement.style.overflow="hidden";document.body.appendChild(e);document.body.appendChild(b);var h=/android/i.test(a)?jvL10n.url.android:/ipad|iphone|ipod/.test(a)&&!window.MSStream?jvL10n.url.ios:jvL10n.url.desktop;c.addEventListener("click",function(){window.open(h)},!0)},2500))};document.addEventListener("DOMContentLoaded",checkUA,!0);</script><?php echo "\n";
}, 1000 );